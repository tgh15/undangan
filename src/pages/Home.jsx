...
function Home() {
    ...
    <>
        ...
        <section id="isi" className="w-full text-black text-center p-5 flex flex-col items-center" style={{backgroundImage: `linear-gradient(to top, #ffffffa0 0%, #bebebe74 100%), url(https://cdn-otwhalal.jetsimg.com/media/2020/07/Background-Undangan-Pernikahan-Klasik-1.jpg)`, backgroundSize: 'cover', backgroundPosition:'center', backgroundRepeat: 'no-repeat'}}>
            <h1 className="text-5xl pb-3 text">We're Getting Married</h1>
            <p className="text font-semibold">Assalamualaikum Warahmatullahi Wabarakatuh.</p>
            ...
            <div>
                <h1 className="nama text-3xl mt-4 text-red-600">Erwin Gautama Putra, S.T </h1>
                <p className="text-left text">( Erwin )</p>
            </div>
            <p className="text">Dengan</p>
            <div>
                <h1 className="nama mt-4 text-3xl text-red-600">Nur Azizah, A.Md. RMIK </h1>
                <p className="text-right text">( Raisa )</p>
            </div>
            <p className="text mt-3">Untuk mengikuti syari'at agama-Mu dan mengikuti sunnah rasul-Mu dalam membentuk keluarga sakinah, mawaddah, warahmah. Maka izinkanlah kami menikahkan mereka.</p>
            ...
            <p className="text mt-3 font-semibold ">Kami memohon do'a dan restu agar proses pernikahan kami berjalan lancar dan dirahmati oleh Allah SWT..</p>
            <img className="p-4 -rotate-3 rounded-md shadow-md bg-white mt-8 " src={foto1} alt="" />
            <h1 className="text-5xl pb-3 text mt-3">Amplop Digital</h1>
            <p className="text font-semibold mb-3">Doa restu anda merupakan karunia yang sangat berarti bagi kami dan jika memberi adalah unkapan tanda terimakasih anda, anda dapat memberi kado secara cashless</p>
            <div className="card rounded-md shadow-md p-4 w-full text mb-4">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Bank_Central_Asia.svg/2560px-Bank_Central_Asia.svg.png" width="100" alt="" />
                <hr className="font-bold text-xl text-black mt-3 mb-3"/>
                <p className="tracking-widest">0251922020</p>
                <p className="tracking-widest">A.N. Erwin Gutama P.</p>
            </div>
        </section>
